...
const updateAuth = (state, authenticated) => {
  state.authenticated = authenticated
}

const addBankAccount = (state, bankAccount) => {
...
const updateBankAccount = (state, bankAccount) => {    
...
const deleteBankAccount = (state, bankAccountId) => {     
...
// const updateBankAccountBalance = (state, bankAccountId) => {
//   // To do
// }

// const updateBankAccountBalances = (state) => {
//   // To do
// }

const addBankAccountValue = (state, accountValue) => {
...
const updateBankAccountValue = (state, accountValue) => {    
  var date = new Date(accountValue.date);
  var dd = date.getDate();
  var mm = date.getMonth()+1;  // As January is 0
  var yyyy = date.getFullYear();
...
// const updateBankAccountValues = (state, payload) => {
//   // To Do
// }

const deleteValuesForBankAccount = (state, accountId) => {
  Vue.delete(state.bankAccountValues, accountId)
}

const deleteBankAccountValue = (state, accountId, accountValueId) => {
  Vue.delete(state.bankAccountValues[accountId], accountValueId)
}

const deleteBankAccountValues = (state, payload) => {
...
const sortBankAccountValues = (state, accountId) => {
...
const setInitialFirstBankAccountId = (state, accountId) => {
