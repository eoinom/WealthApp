...
const initialiseBankAccounts = ({ commit }, bankAccounts) => {
...
async function addBankAccount ({ commit }, account) {
...
async function updateBankAccount ({ commit }, account) {
...
// const updateBankAccountValues = ({ commit }, payload) => {
//   // Not implemented
//   // commit('updateBankAccountValues', payload)
// }

const sortBankAccountValues = ({ commit }, accountId) => {
