...
namespace backendAPI.Types
{
    public class AccountValueType : ObjectGraphType<AccountValue>
    {
        public AccountValueType()
        {
            ...
            Field(x => x.Account, nullable: false, type: typeof(AccountType)).Description("The bank account which the account value applies to.");
            ...
            //Field(x => x.Loan, nullable: false, type: typeof(LoanType)).Description("The mortgage account which the account value applies to.");
        }
    }
}