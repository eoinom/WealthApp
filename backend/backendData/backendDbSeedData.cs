    ...
    public static class backendDbSeedData
    {
        ...
        private static void EnsureLoanValuesSeedData(backendDbContext db)
        {
            if (!db.LoanValues.Any())
            {
                ...
                {
                    new LoanValue { Date = new DateTime(2018, 8, 20), Value = 300000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2018, 9, 20), Value = 299533.75m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2018, 10, 20), Value = 299066.33m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2018, 11, 20), Value = 298597.75m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2018, 12, 20), Value = 298127.99m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 1, 20), Value = 297657.06m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 2, 20), Value = 297184.95m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 3, 20), Value = 296711.66m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 4, 20), Value = 296237.19m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 5, 20), Value = 295761.53m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },
                    new LoanValue { Date = new DateTime(2019, 6, 20), Value = 295284.68m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 1) },

                    new LoanValue { Date = new DateTime(2018, 11, 18), Value = 10000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 11, 25), Value = 9971.03m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 12, 2), Value = 9942m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 12, 9), Value = 9912.91m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 12, 16), Value = 9883.76m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 12, 23), Value = 9854.55m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2018, 12, 30), Value = 9825.28m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 1, 6), Value = 9795.95m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 1, 13), Value = 9766.55m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 1, 20), Value = 9737.09m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 1, 27), Value = 9707.57m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 2, 3), Value = 9677.99m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 2, 10), Value = 9648.35m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 2, 17), Value = 9618.64m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 2, 24), Value = 9588.87m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 3, 3), Value = 9559.04m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 3, 10), Value = 9529.15m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 3, 17), Value = 9499.19m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 3, 24), Value = 9469.17m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },
                    new LoanValue { Date = new DateTime(2019, 3, 31), Value = 9439.09m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 2) },

                    new LoanValue { Date = new DateTime(2018, 5, 12), Value = 40000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 6, 12), Value = 39480.72m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 7, 12), Value = 38957.2m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 8, 12), Value = 38429.4m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 9, 12), Value = 37897.29m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 10, 12), Value = 37360.83m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 11, 12), Value = 36819.99m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2018, 12, 12), Value = 36274.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 1, 12), Value = 35725.03m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 2, 12), Value = 35170.83m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 3, 12), Value = 34612.11m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 4, 12), Value = 34048.83m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 5, 12), Value = 33480.95m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },
                    new LoanValue { Date = new DateTime(2019, 6, 12), Value = 32908.43m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 3) },

                    new LoanValue { Date = new DateTime(2019, 2, 10), Value = 8000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 2, 17), Value = 7931.85m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 2, 24), Value = 7863.54m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 3, 3), Value = 7795.08m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 3, 10), Value = 7726.46m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 3, 17), Value = 7657.68m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 3, 24), Value = 7588.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 3, 31), Value = 7519.64m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 4, 7), Value = 7450.38m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 4, 14), Value = 7380.96m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 4, 21), Value = 7311.38m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 4, 28), Value = 7241.64m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 5, 5), Value = 7171.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 5, 12), Value = 7101.68m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 5, 19), Value = 7031.46m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 5, 26), Value = 6961.08m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 6, 2), Value = 6890.53m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 6, 9), Value = 6819.82m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 6, 16), Value = 6748.95m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },
                    new LoanValue { Date = new DateTime(2019, 6, 23), Value = 6677.91m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 4) },

                    new LoanValue { Date = new DateTime(2018, 3, 1), Value = 400000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 4, 1), Value = 399423.67m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 5, 1), Value = 398845.42m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 6, 1), Value = 398265.24m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 7, 1), Value = 397683.13m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 8, 1), Value = 397099.08m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 9, 1), Value = 396513.08m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 10, 1), Value = 395925.13m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 11, 1), Value = 395335.22m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2018, 12, 1), Value = 394743.34m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 1, 1), Value = 394149.49m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 2, 1), Value = 393553.66m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 3, 1), Value = 392955.85m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 4, 1), Value = 392356.04m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 5, 1), Value = 391754.23m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 6, 1), Value = 391150.42m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },
                    new LoanValue { Date = new DateTime(2019, 7, 1), Value = 390544.59m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 5) },

                    new LoanValue { Date = new DateTime(2018, 1, 18), Value = 280000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },
                    new LoanValue { Date = new DateTime(2018, 4, 18), Value = 277823.5m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },
                    new LoanValue { Date = new DateTime(2018, 7, 18), Value = 275622.51m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },
                    new LoanValue { Date = new DateTime(2018, 10, 18), Value = 273396.76m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },
                    new LoanValue { Date = new DateTime(2019, 1, 18), Value = 271145.97m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },
                    new LoanValue { Date = new DateTime(2019, 4, 18), Value = 268869.86m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 6) },

                    new LoanValue { Date = new DateTime(2018, 9, 1), Value = 18000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2018, 10, 1), Value = 17766.94m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2018, 11, 1), Value = 17531.96m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2018, 12, 1), Value = 17295.04m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 1, 1), Value = 17056.16m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 2, 1), Value = 16815.31m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 3, 1), Value = 16572.48m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 4, 1), Value = 16327.64m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 5, 1), Value = 16080.78m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 6, 1), Value = 15831.89m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },
                    new LoanValue { Date = new DateTime(2019, 7, 1), Value = 15580.94m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 7) },

                    new LoanValue { Date = new DateTime(2018, 9, 1), Value = 12000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 9, 15), Value = 11932.24m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 9, 29), Value = 11864.17m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 10, 13), Value = 11795.79m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 10, 27), Value = 11727.1m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 11, 10), Value = 11658.09m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 11, 24), Value = 11588.77m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 12, 8), Value = 11519.13m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2018, 12, 22), Value = 11449.17m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 1, 5), Value = 11378.89m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 1, 19), Value = 11308.29m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 2, 2), Value = 11237.37m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 2, 16), Value = 11166.12m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 3, 2), Value = 11094.55m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 3, 16), Value = 11022.65m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 3, 30), Value = 10950.42m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 4, 13), Value = 10877.86m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 4, 27), Value = 10804.97m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 5, 11), Value = 10731.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },
                    new LoanValue { Date = new DateTime(2019, 5, 25), Value = 10658.18m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 8) },

                    new LoanValue { Date = new DateTime(2018, 6, 1), Value = 4000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 7, 1), Value = 3685.34m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 8, 1), Value = 3367.4m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 9, 1), Value = 3046.15m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 10, 1), Value = 2721.55m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 11, 1), Value = 2393.57m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2018, 12, 1), Value = 2062.17m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 1, 1), Value = 1727.32m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 2, 1), Value = 1388.98m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 3, 1), Value = 1047.12m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 4, 1), Value = 701.7m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 5, 1), Value = 352.68m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 6, 1), Value = 0.02m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },
                    new LoanValue { Date = new DateTime(2019, 7, 1), Value = -356.31m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 9) },

                    new LoanValue { Date = new DateTime(2019, 1, 28), Value = 40000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },
                    new LoanValue { Date = new DateTime(2019, 2, 28), Value = 39814.59m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },
                    new LoanValue { Date = new DateTime(2019, 3, 28), Value = 39627.5m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },
                    new LoanValue { Date = new DateTime(2019, 4, 28), Value = 39438.71m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },
                    new LoanValue { Date = new DateTime(2019, 5, 28), Value = 39248.2m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },
                    new LoanValue { Date = new DateTime(2019, 6, 28), Value = 39055.96m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 10) },

                    new LoanValue { Date = new DateTime(2019, 3, 1), Value = 4000m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 3, 8), Value = 3927.7m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 3, 15), Value = 3855.22m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 3, 22), Value = 3782.57m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 3, 29), Value = 3709.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 4, 5), Value = 3636.74m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 4, 12), Value = 3563.56m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 4, 19), Value = 3490.21m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 4, 26), Value = 3416.68m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 5, 3), Value = 3342.97m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 5, 10), Value = 3269.09m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 5, 17), Value = 3195.03m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 5, 24), Value = 3120.79m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 5, 31), Value = 3046.37m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 6, 7), Value = 2971.77m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 6, 14), Value = 2896.99m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 6, 21), Value = 2822.03m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 6, 28), Value = 2746.89m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                    new LoanValue { Date = new DateTime(2019, 7, 5), Value = 2671.57m, Loan = db.Loans.FirstOrDefault(x => x.LoanId == 11) },
                };
